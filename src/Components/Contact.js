...
const Contact = ({ data }) => {
   const [url, setUrl] = useState('mailto:subhampanda2899@gmail.com?subject=subject&body=body');
            ...
            <aside className="four columns footer-widgets">
               <div className="widget widget_contact">
                  ...
                  <p className="address">
                     ...
                     <a href="mailto:subhampanda2899@gmail.com"> subhampanda2899@gmail.com </a>
                  </p>
               </div>
